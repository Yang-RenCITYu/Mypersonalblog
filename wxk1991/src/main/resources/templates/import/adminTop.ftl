    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-example">
            <ul class="nav navbar-nav">
                <li><a href="/wxk1991/"><i class="icon-list-ol"></i> 基础数据</a></li>
                <li class="dropdown">
                ...
                <li><a href="/wxk1991/ad/list"><i class="icon-dollar"></i> 广告管理</a></li>
                <li><a href="/wxk1991/link/list"><i class="icon-smile"></i>友情连接</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="/wxk1991/logout"><i class="icon-signout"></i> 退出登陆</a></li>
                    </ul>
                </li>
